...
It uses the [Medieval town I](https://www.myminifactory.com/object/3d-print-the-medieval-town-part-1-dungeon-blocks-342512) tile set.  There isn't really a good "cage" block so I used three of the MT1-022 Wooden Crates 4 tile since it has a cage (along with crates) on it.  It'd probably be better to use normal floor tiles and then use some other dungeon scatter terrain as the cages. Ultimate dungeon has a neat cage tile but its attached to a wall.  

![layout](Eliats%20Lost%20Familiars.png)
